	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="归还时间" prop="guihaishijian" >
				...
				<el-form-item class="select" v-if="type!='info'"  label="服务评分" prop="fuwupingfen" >
					<el-select :disabled="ro.fuwupingfen" v-model.number="ruleForm.fuwupingfen" placeholder="请选择服务评分" >
						<el-option
				...
				<el-form-item v-else class="input" label="服务评分" prop="fuwupingfen" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="评价反馈" prop="pingjiafankui" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.pingjiafankui" label="评价反馈" prop="pingjiafankui" >
				<span class="text">{{ruleForm.pingjiafankui}}</span>
			</el-form-item>
