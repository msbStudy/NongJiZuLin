	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="性能参数" prop="xingnengcanshu" >
					<el-input v-model="ruleForm.xingnengcanshu" placeholder="性能参数" clearable  :readonly="ro.xingnengcanshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="性能参数" prop="xingnengcanshu" >
					<el-input v-model="ruleForm.xingnengcanshu" placeholder="性能参数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="农机状态" prop="nongjizhuangtai" >
					<el-select :disabled="ro.nongjizhuangtai" v-model="ruleForm.nongjizhuangtai" placeholder="请选择农机状态" >
						<el-option
				...
				<el-form-item v-else class="input" label="农机状态" prop="nongjizhuangtai" >
					<el-input v-model="ruleForm.nongjizhuangtai"
						placeholder="农机状态" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'"  label="农机详情" prop="nongjixiangqing" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.nongjixiangqing" label="农机详情" prop="nongjixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.nongjixiangqing"></span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.nongjizhuangtai = '空闲'; 				}
				// 获取用户信息
				this.$http({
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.nongjixiangqing = this.ruleForm.nongjixiangqing.replace(reg,'../../../springboot2063u69l/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `zulinfuwu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zulinfuwuCrossAddOrUpdateFlag = false;
											this.parent.search();
