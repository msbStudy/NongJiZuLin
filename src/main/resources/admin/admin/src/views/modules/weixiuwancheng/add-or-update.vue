	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="维修结果" prop="weixiujieguo" >
					<el-input v-model="ruleForm.weixiujieguo" placeholder="维修结果" clearable  :readonly="ro.weixiujieguo"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="维修结果" prop="weixiujieguo" >
					<el-input v-model="ruleForm.weixiujieguo" placeholder="维修结果" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'"  label="维修内容" prop="weixiuneirong" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.weixiuneirong" label="维修内容" prop="weixiuneirong" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.weixiuneirong"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.weixiuneirong = this.ruleForm.weixiuneirong.replace(reg,'../../../springboot2063u69l/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
