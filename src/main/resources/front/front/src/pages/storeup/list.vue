<template>
	<div :style='{"width":"1200px","padding":"20px","margin":"10px auto","position":"relative","background":"none"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250120/bd3f11cd39054b2c9983b54078a7d4c6.png) no-repeat left center","width":"auto","lineHeight":"44px","fontSize":"22px","fontWeight":"600"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"width":"100%","padding":"0 calc(50% - 600px)","margin":"10px auto","whiteSpace":"nowrap","color":"#333","fontWeight":"500"}'
